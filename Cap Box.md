NMAP
![Screenshot](images/Pasted image 20260916115113.png)

Data Section 
![Screenshot](images/Pasted image 20260915235704.png)
	1 can be changed to 0 find other users records

.pcap wireshark creds
![Screenshot](images/Pasted image 20260916000149.png)
	-Open username and password in downloadable .pcap file

SSH into user
![Screenshot](images/Pasted image 20260916000636.png)
	-We can then SSH into this user in order to get access to the system

Linpeas
![Screenshot](images/Pasted image 20260916002206.png)
...
![Screenshot](images/Pasted image 20260916002749.png)

Complete Root Access
![Screenshot](images/Pasted image 20260916002911.png)
